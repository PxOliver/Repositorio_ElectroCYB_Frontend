    ...
    <header className="bg-white shadow-lg sticky top-0 z-50">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="flex justify-between items-center py-4">
          ...
          {/* Zona derecha en móvil: solo usuario + carrito (sin menú aquí) */}
        ...
        {/* Botón menú HAMBURGUESA ABAJO (solo móvil) */}
        ...
        {/* Navegación móvil debajo del botón */}
        {isMenuOpen && (
          <div className="md:hidden pb-4">
            <nav className="flex flex-col space-y-2">
              ...
              {/* Catálogo solo para NO admins en móvil */}
              {!isAdmin && (
                <Link
                  to="/catalogo"
                  onClick={() => setIsMenuOpen(false)}
              ...
              {/* Contáctanos solo para NO admins en móvil */}
              {!isAdmin && (
                <Link
                  to="/contacto"
                  onClick={() => setIsMenuOpen(false)}
